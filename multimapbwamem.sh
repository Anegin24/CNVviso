...
bwa mem $ref $forwardread > ~/Bioinformatics/Test31/sam/${outputfilename}.sam

cd ~/Bioinformatics/Test31/processbam

samtools view -b -o ${outputfilename}.bam ~/Bioinformatics/Test31/sam/${outputfilename}.sam
...
samtools markdup -r -@ 20 ${outputfilename}.sorted.p.bam ~/Bioinformatics/Test31/finalbam/${outputfilename}.dedup.bam
